...
def input_pipeline(dataset_pattern='train-*', is_training=True, batch_size=FLAGS.batch_size):
    def input_fn():
        ...
        image_preprocessing_fn = lambda image_, labels_, bboxes_ : ssd_preprocessing.preprocess_image(image_, labels_, bboxes_, [128.,128.,128.], out_shape, is_training=is_training, data_format=FLAGS.data_format, output_rgb=True)

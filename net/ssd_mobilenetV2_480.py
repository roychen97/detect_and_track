...
class MobileNetV2(object):
    ...
    def forward(self, inputs, training=False):
        ...
        inputs = self._dw_conv2('layer_19_2_Conv2d_2_3x3_s2_512_depthwise', inputs, kernel=3, stride=2,activation=tf.nn.relu6, padding='VALID')
        ...
        inputs = self._dw_conv2('layer_19_2_Conv2d_3_3x3_s2_256_depthwise', inputs, kernel=3, stride=1, activation=tf.nn.relu6, padding='VALID')
    ...
    def expand_blocks(self, name, x, kernel=3, filters=96, stride=1, k=6, residual=False, padding='SAME'):
        with tf.variable_scope(name):
          ...
          conv_2 = self._dw_conv2('depthwise', conv_1, kernel=kernel, stride=stride, activation=tf.nn.relu6, padding=padding)
          # project
